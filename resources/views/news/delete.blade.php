        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to delete this news post? Please note that changes cannot be reversed!
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button> {!!Form::open(['action'
                    => ['NewsController@destroy', $newsItem->id], 'method' => 'POST'])!!} {{Form::hidden('_method', 'DELETE')}}
